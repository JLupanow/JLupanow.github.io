...
I needed to find a way to bring his operations online with a new responsive website design.
...
Preliminary analysis of competitors made it clear that the site was missing more modern features like online shopping and chatbots that frequently appear on other floral shop sites.
But to determine what the customers really wanted from Petal Pushers, I conducted user interviews. 

![](/images/projects/petal-pushers/first-customers.png)

<div class="caption"><i>My interview questions for first-time customers.</i></div>

![](/images/projects/petal-pushers/return-customers.png)

<div class="caption"><i>My interview questions for returning customers.</i></div>

From these interviews, two distinct personas emerged.

![](/images/projects/petal-pushers/primary-persona.png)

<div class="caption"><i>Primary persona: the student buyer.</i></div>

![](/images/projects/petal-pushers/secondary-persona.png)

<div class="caption"><i>Secondary persona: the supportive parent.</i></div>

While both personas make up large portions of the shop's customer base according to stakeholder interviews, the student buyer is more likely than the supportive parent to complete all their ordering online. 
This means that a new website may have the greatest impact on these customers and that this persona of the student buyer is my primary persona.

### Determine the Use Cases {#cases}

To better understand the needs and goals of the primary persona, I fleshed out a goal-directed context scenario and the three top use cases for the new site. 
The shop traditionally accepts requests, provides a client with options based on budget and preferences, and asks clients to select and pay for their arrangement prior to delivery. 
This structure is mimicked by the use cases:
...
After conducting user research and defining the desired experience of my primary persona, I began work on the information architecture by way of a site map.

![](/images/projects/petal-pushers/sitemap.png)

<div class="caption"><i>Sitemap for the new Petal Pushers site.</i></div>

The sitemap coupled with features and functionality lists and user flows took began to take form with wireframes created in Sketch. 
I created both desktop and mobile wireframes of the site as it needs to be responsive to match the needs of the users.

![](/images/projects/petal-pushers/wireframes-shop.png)

<div class="caption"><i>Desktop and mobile wireframes of the shopping page (2.0).</i></div>
...
To determine if these designs meet the needs of my primary persona, I applied visual design principles to the mobile wireframes and turned those into a functional prototype so that I could test the functionality along with the look and feel of the site with potential users.
...
I also redesigned the logo for the site so it would fit with this new palette and the overall more modern look of the site. 
...
To test the changes to the site and see if they met user needs, I first needed to add functionality to my site pages. 
I did this using prototyping links and hotspots in Sketch.

### Test the Usability {#usability}

With the functional prototype, I was able to begin usability testing. 
I needed to test the site with those that fit my personas to see if the design was clear enough that they could follow the use cases. 
...
I used the tool Validately to conduct my unmoderated usability tests. 
...
If I were to continue working on this project, **I would further simplify the user flow** by allowing users to place their order right away (with the caveat that arrangements are subject to change but the total cost will always be equal to or less than the listed price) and send them an email asking them to review any changes to their arrangements. 
The florist would be able to adapt the arrangement based on the current floral selection and they don't have to wait for the customer to respond to their messages. 
Thus, the simplified user flow would make the process easier for users and support business objectives of increasing revenue through online sales without changing the traditional operation methods.
